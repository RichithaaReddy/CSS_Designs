    ...
    <div className="container">
      ...
      <style jsx>{`
        .container {
          ...
          /* Define background images and rotations for each carousel__face here */
...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Rotating 3D Carousel</title>
        <meta name="description" content="Rotating 3D Carousel in Next.js" />
      </Head>
