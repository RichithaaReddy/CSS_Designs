...
<div className="flex text-white flex-wrap  h-screen">
  <section className="relative mx-auto">
    <nav className="flex justify-between bg-gray-900 text-white w-screen">
      <div className="px-5 xl:px-12 py-6 flex w-full items-center">
        <a className="text-3xl  text-white font-bold font-heading" href="#">
          Logo Here.
        </a>
        <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
          <li><a className="hover:text-gray-200 text-white" href="#">Home</a></li>
          <li><a className="hover:text-gray-200 text-white" href="#">Catagory</a></li>
          <li><a className="hover:text-gray-200 text-white" href="#">Collections</a></li>
          <li><a className="hover:text-gray-200 text-white" href="#">Contact Us</a></li>
        </ul>
